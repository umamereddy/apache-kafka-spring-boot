Apache Kafka
=================
See complete [web site](https://kafka.apache.org) for details on the project.

You need to have [Java](http://www.oracle.com/technetwork/java/javase/downloads/index.html) installed.

I build and test Apache Kafka with Java 8, 11 and 17. We set the `release` parameter in javac and scalac
